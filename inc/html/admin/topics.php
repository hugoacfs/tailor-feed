...
<div class="col-xs-12 col-sm-12 col-lg-12">
    <nav>
        <ol class="breadcrumb text-light bg-dark">
            ...
            <li id="topics-page" class="breadcrumb-item active text-light">
                Topics
            </li>
        </ol>
    </nav>
        ...
        <table class="table table-dark tableFixHead table-striped " data-sortable>
            ...
            <tbody>
                ...
                foreach ($topics as $topic) {
                    ...
                    echo '<form class="button-form" method="POST" action="admin.php?table=topics">';
                    echo '<div class="form-group hidden d-none"><input type="hidden" class="form-control" name="id" value="' . $id . '"></div>';
                    echo '<div class="form-group hidden d-none"><input type="hidden" class="form-control" name="action"  value="delete-topic"></div>';
